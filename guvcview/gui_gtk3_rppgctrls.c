...
int gui_attach_gtk3_rppgctrls(GtkWidget *parent)
{
	...
	/* ----- Filter controls -----*/
	line++;
	GtkWidget *label_audioFilters = gtk_label_new(_("---- rPPG Filters ----"));
#if GTK_VER_AT_LEAST(3,15)
	...
	/* Echo FX */
	GtkWidget *FiltEchoEnable = gtk_check_button_new_with_label (_(" HeartBeat"));
	...
	/* Reverb FX */
	GtkWidget *FiltReverbEnable = gtk_check_button_new_with_label (_(" Respiratory"));
